...
variable NeveryMedium equal 1000
...
neigh_modify    one 5000 page 200000
...
fix             freact_creation all bond/react stabilization no reset_mol_ids no &
                react Nucleation all ${NeveryMedium} ${RminF} ${RmaxFB} nucleation_pre nucleation_post ../../templates/Nucleation/map_Nucleation.txt prob 1 ${lseed1} modify_create nuc xwalls -2 &
                react Death all ${NeveryMedium} ${RminF} ${RmaxFB} death_pre death_post ../../templates/Nucleation/map_Death.txt prob 1 ${lseed1} &
